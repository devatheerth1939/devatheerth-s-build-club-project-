...
2. INPUT THE PATH(RELATIVE/ABSOLUTE)IN THE INPUT LINE IF YOU WANT TO PASS AN EXISTING VIDEO FILE ,IF YOU WANT TO USE WEBCAM LIVESTREAM INPUT 0
3.RUN THE CODE AND IT WILL ENCLOSE IN A BLUE RECTANGULAR BOX THE DETECTED FACES IN THE VIDEO FILE/LIVESTREAM
4. WHEN THE VIDEO FILE ENDS A DIALOGUE BOX POPS UP SHOWING END OF VIDEO FILE WHICH HELPS TO HANDLE THE OPEN CV ERROR .
5. THE INPUT VIDEO IS IN THE ASSETS FILE AND THE OUTPUT VIDEO IS IN THE RESULTS FILE 
6.END  
